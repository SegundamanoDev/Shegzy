					...
					<div className='left_items_wrapper'>
						<div className='discssn'>
							...
							<p>
								...
								From Over 230 Countries Worldwide Door-To-Door. This Can Be Done
						...
						<div className='discssn'>
							...
							<p>
								SHEGZY can ship your goods anywhere in the world. Our
						...
						<div className='discssn'>
							...
							<p>
								...
								knowledge and know-how of dealing with customs related issues in
								Nigeria. For your peace of mind, we provide a wide range of
								customs support for standard as well as non-routine
								customs-clearance processes. By making sure that clearance is a
								smooth and efficient process, we ensure your shipments arrive as
								quickly as possible, and leave you free to focus on your core
								business ideal for larger shipments, we work with the best
								airlines in the world to guarantee you safe and quick delivery,
								with full tracking visibility, customs clearance, expert
								handling of shipping and regulatory paperwork. Our air freight
						...
						<div className='discssn'>
							...
							<p>
								...
								including freight and customs clearance into Nigeria,
								warehousing, order processing, pick and pack, nationwide
								distribution services and returns management to overseas online
								retailers
							</p>
						</div>
					</div>
